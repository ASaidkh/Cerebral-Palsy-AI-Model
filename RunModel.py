...
DATA_DIR = 'Template CSVs'  # Directory with CSV files from FHIR data
OUTPUT_DIR = '2025-4-14'  # Directory for saving output files

# Timeline generation settings
FORCE_NEW_TIMELINES = False  # Set to True to regenerate all patient timelines from scratch
APPEND_NEW_MONTHS = True     # Set to True to append new months of data for existing patients
...
def main():
    ...
    if MODE == 'train':
        ...
        feature_importance = pipeline_results['feature_importance']
